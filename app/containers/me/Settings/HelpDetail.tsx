    ...
    steps: [
      {
        title: '',
        content: [
          'First step:Open the home page of LCP and Click on the “Work”;',
    ...
    steps: [
      {
        title: '',
        content: [
          'First step:Open the home page of LCP and Choose the template you want to fill in;',
    ...
    steps: [
      {
        title: 'The first way:',
        content: [
          'Open the home page of LCP and Choose the template you want to fill in.',
        ],
      },
      {
    ...
    steps: [
      {
        title: 'The first way:',
        content: [
          'First step:Open the home page of LCP and Click on the “Data”;',
    ...
    steps: [
      {
        title: '',
        content: [
          'First step:Open the home page of LCP and Click on the “Me”;',
