...
import {updateDepartmentMap} from '../../../store/actions';
...
export class DepartmentSelect extends Component<Props, State> {
  ...
  componentWillMount() {
    ...
    if (company_id) {
      ...
      requestApiV2(API_v2.getDepartment, {companyId: company_id}, authToken)
        .then(res => {
          ...
          if (Array.isArray(res.data)) {
            ...
            this.props.dispatch(updateDepartmentMap(departmentMap));
          } else {
