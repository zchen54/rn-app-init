export const API_v2 = {
  ...
  getCaptcha: {method: 'GET', url: 'captcha'}, // 1
  // company
  ...
  sendReportEmail: {method: 'POST', url: 'email/report'}, // 1
  dataApproval: {method: 'PUT', url: 'approval'}, // 1

  // task
  getTaskList: {method: 'GET', url: 'task/list'}, // 1
  ...
  getCurrencyUnit: {method: 'GET', url: 'currency'}, // 1
