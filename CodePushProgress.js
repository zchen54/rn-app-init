...
export default class CodePushProgress extends Component {
  static propTypes = {
    ...View.propTypes,
    // 当前进度
...
Object.defineProperty(CodePushProgress.prototype, "progress", {
  set(value) {
...
Object.defineProperty(CodePushProgress.prototype, "buffer", {
  set(value) {
